...
CC := gcc
SERVER_OBJ := server_src/main.o server_src/helper.o server_src/udp.o server_src/tcp.o common/helper.o common/queue.o
MASTER_OBJ := master_src/main.o master_src/helper.o master_src/tcp.o common/helper.o
